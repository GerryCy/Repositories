...
<body>
		...
		<div class="span5">
			<div class="logo">
				<a href="./网上商城/index.htm"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/top_01.png"
					/> </a>
			</div>
		</div>
		<div class="span9">
						...
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">
								<s:if test="#order.state == 1">
									<a href="${ pageContext.request.contextPath }/order_findByOid.action?oid=<s:property value="#order.oid" />">查看订单详情</a>
								</s:if>
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 2018 网上商城系统</div>
		</div>
	</div>
</body>
</html>